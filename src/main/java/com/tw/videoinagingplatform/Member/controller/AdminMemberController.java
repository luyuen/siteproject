...
import com.tw.videoinagingplatform.Member.model.Member;
...
public class AdminMemberController {
	...
	public String deleteMember(int member_id, Member member) {
		return "/admin/member/QueryAll";
	}

	@GetMapping(path = "update/{member_id}")
	public String updatemember(int member_id, Member member) {
		return "/admin/member/QueryAll";
	}
